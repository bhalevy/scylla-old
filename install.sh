...
install -m755 tools/scylla-housekeeping -Dt "$rprefix"/lib/scylla/
...
cp -r tools/scylla-housekeeping "$rprefix"/lib/scylla/scylla-housekeeping
install -d "$rprefix"/sbin
cp -P dist/common/sbin/* "$rprefix"/sbin
install -m755 tools/scylla-gdb.py -Dt "$rprefix"/lib/scylla/
