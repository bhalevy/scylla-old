...
struct column_stats {
    ...
    void update_local_deletion_time_and_timestamp_histogram(int32_t value) {
        local_deletion_time_tracker.update(value);
        tombstone_histogram.update(value);
    }
    void update_local_deletion_time_and_timestamp_histogram(gc_clock::time_point value) {
        update_local_deletion_time_and_timestamp_histogram(gc_clock::as_int32(value));
    }
    ...
    void update(const deletion_time& dt) {
        ...
        update_local_deletion_time_and_timestamp_histogram(dt.local_deletion_time);
    }
    void do_update(const tombstone& t) {
        update_timestamp(t.timestamp);
        update_local_deletion_time_and_timestamp_histogram(t.deletion_time);
    }
