...
void sstable::write_cell(file_writer& out, atomic_cell_view cell, const column_definition& cdef) {
    ...
    if (cell.is_dead(_now)) {
        ...
        _c_stats.update_local_deletion_time_and_timestamp_histogram(deletion_time);
    ...
    if (cdef.is_counter()) {
      ...
      counter_cell_view::with_linearized(cell, [&] (counter_cell_view ccv) {
        ...
        _c_stats.update_local_deletion_time_and_timestamp_histogram(expiration);
...
encoding_stats sstable::get_encoding_stats() const {
    ...
    stats.min_local_deletion_time = gc_clock::time_point(gc_clock::duration(serialization_header.get_min_local_deletion_time(has_wide_local_deletion_time())));
    stats.min_ttl = gc_clock::duration(serialization_header.get_min_ttl(has_wide_local_deletion_time()));
