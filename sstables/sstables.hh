...
public:
    ...
    static sstring filename(sstring const& dir, sstring const& ks, sstring const& cf, version_types version, int64_t generation,
    ...
    sstring filename(sstring const& dir, component_type f) const {
    ...
    static sstring temp_sst_dir(sstring const& dir, unsigned long gen) {
    ...
    future<> create_links(sstring const& dir, int64_t generation) const;

    future<> create_links(sstring const& dir) const {
