...
SEASTAR_THREAD_TEST_CASE(test_distributed_loader_with_pending_delete) {
    ...
    write_file(pending_delete_dir + "/sstables-4-5.log",
               gen_filename(4, component_type::TOC) + "\n" +
               gen_filename(5, component_type::TOC) + "\n");
    ...
    write_file(pending_delete_dir + "/sstables-6-8.log",
               gen_filename(6, component_type::TOC) + "\n" +
               gen_filename(7, component_type::TOC) + "\n" +
               gen_filename(8, component_type::TOC) + "\n");
