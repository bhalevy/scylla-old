...
SEASTAR_TEST_CASE(datafile_generation_01) {
    ...
    return test_setup::do_with_tmp_directory([] (test_env& env, sstring tmpdir_path) {
        schema_builder builder(make_lw_shared(schema(utils::make_random_uuid(), some_keyspace, some_column_family,
...
SEASTAR_TEST_CASE(datafile_generation_07) {
    ...
    return test_setup::do_with_tmp_directory([] (test_env& env, sstring tmpdir_path) {
        auto s = make_lw_shared(schema(utils::make_random_uuid(), some_keyspace, some_column_family,
            {{"p1", utf8_type}}, {{"c1", utf8_type}}, {{"r1", int32_type}}, {}, utf8_type));
